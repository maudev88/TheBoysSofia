...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin: 50px 50px;">
        ...
        <div class="row">
            <div class="col-4">
                <h1 class="ache2" style="margin-bottom: 20px;">Registro</h1>
                ...
                <div id="botones">
                    <asp:Button Text="Ingresar" CssClass="btn botonn btnhover" Style="background-color: #5ae7fb; color: red; font-weight: bolder;" ID="btnRegistro" OnClick="btnRegistro_Click" runat="server" CausesValidation="true" />
